...
public class Space3D_4 extends PApplet {
...
/*  //30 0 220
  ...
  line(screenX(0), screenY(0), screenZ(-10),
   ...
   stroke(55,255,25);       
  for(x=-10.0f; x<=10.0f; x++)
  {
    for(y=-10.0f; y<=10.0f; y++)
    {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "Space3D_4" });
  }
}
