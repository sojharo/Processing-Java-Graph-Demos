...
public class Space3D extends PApplet {
...
public void draw() {
  ...
  strokeWeight(2);
  //30 0 220
  camera(camX+30, camY+0, camX+180.0f, // eyeX, eyeY, eyeZ
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "Space3D" });
  }
}
